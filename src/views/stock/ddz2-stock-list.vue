...
<template>
    <div>
        ...
        <Row class="margin-top-0 searchable-table-con1">
            <Header style="text-align: center; font-weight: bolder; font-size:20px; background-color: #ff9900">斗地主-新手场</Header>
            <Table :columns="columnShare" :data="dataXinshou"></Table>
        </Row>
        <Row class="margin-top-0 searchable-table-con1">
            <Header style="text-align: center; font-weight: bolder; font-size:20px; background-color: #ff9900">斗地主-大众场</Header>
            <Table :columns="columnShare" :data="dataDazhong"></Table>
        </Row>
        <Row class="margin-top-0 searchable-table-con1">
            <Header style="text-align: center; font-weight: bolder; font-size:20px; background-color: #ff9900">斗地主-精英场</Header>
            <Table :columns="columnShare" :data="dataJingying"></Table>
        </Row>
        <Row class="margin-top-0 searchable-table-con1">
            <Header style="text-align: center; font-weight: bolder; font-size:20px; background-color: #ff9900">斗地主-富豪场</Header>
            <Table :columns="columnShare" :data="dataFuhao"></Table>
        </Row>
        <Row class="margin-top-0 searchable-table-con1">
            <Header style="text-align: center; font-weight: bolder; font-size:20px; background-color: #ff9900">斗地主-至尊场</Header>
            <Table :columns="columnShare" :data="dataZhizun"></Table>
        </Row>
        <Row class="margin-top-0 searchable-table-con1">
            <Header style="text-align: center; font-weight: bolder; font-size:20px; background-color: #ff9900">斗地主-贵宾场</Header>
...
export default {
    ...
    methods: {
        requestData(){
            let url= api.URL.Stock_Query_DDZ2();
            const dataXinshou= {
                commonValue: 0,
                tableValue: 0,
                tableFee: 0,
        ...
        showChangeStock(gameId, senceId){
            this.$Modal.confirm({
                    ...
                    onOk: ()=> {  
                        ...
                        let url= api.URL.Stock_Update_DouDiZhu2();
                        let _this= this;
        ...
        const cols= shareColumns.forEach(item=>{
            item['render']= (h, params)=>{
                ...
                if(columnKey!= 'gameId'&& columnKey!= 'sceneId'){
                    // return h('div', [h('span', {style:{'margin-right': '10px'}}, info), h('Button', {props: {
                    //     type: 'primary',
                    //     size: 'small'
                    // }, nativeOn: {
